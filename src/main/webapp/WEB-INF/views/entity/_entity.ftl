...
<#else>
  ...
  <#macro content>
    <div id="content" class="col-xs-12">
      ...
      <div class="row">
        <div class="col-xs-8">
          <h1><a href="<@mtl.url view.entityData.url/>">${view.entityData.name}</a></h1>
          <@printLikeButton uid=view.entityData.muidSerialized currentVote=view.entityData.likeData.currentVote upNum=view.entityData.likeData.upVoteNum downNum=view.entityData.likeData.downVoteNum/>
          <#nested>
        </div>
